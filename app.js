...
//Getting the element that hold the name of the song
var songElement = document.getElementsByClassName("name")


try {
    for (j = 0; j <= songs.length; j++) {
        var nameProp = songs[j]
        songElement[j].innerHTML = nameProp.name;
    }
